...
def game_over(name):
    ...
    if name == "player":
        player_label = Label(frame_gameover, bg="green",
                             text=" COMPUTER HAD LOWER CARD {}".format(min(computer_numbers)),
...
def how_to_play():
    ...
    If the smallest card is not thrown, the game stops.
        ...
        """, font=("Helvatica", 12), relief="sunken", justify="left", bg="light green", bd=0).pack(pady=0, ipady=0,
                                                                                                   ipadx=0)
